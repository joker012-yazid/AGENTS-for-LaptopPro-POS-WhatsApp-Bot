...
async function seed() {
  ...
  await run(db, 'INSERT INTO whatsapp_messages_fts(whatsapp_messages_fts) VALUES(\'rebuild\')');
  await run(db, 'INSERT INTO queue_manual (id, remote_jid, last_text, reason, created_at, status) VALUES (1,?,?,?,?,?)', [
    '1@s.whatsapp.net',
    'Need help',
    'seed',
    now,
